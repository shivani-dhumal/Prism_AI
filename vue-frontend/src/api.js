/* PrismAI API helper — mirrors /frontend/static/js/api.js */
...
export const API = {
  ...
  // Audit
  auditIssues: () => req('/api/audit/issues'),

  // Dependencies
  dependencies: (root) => req(`/api/dependencies${root ? `?root=${encodeURIComponent(root)}` : ''}`),
